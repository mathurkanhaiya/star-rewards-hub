...
const GROUPS: {
  ...
  },
  {
    ...
    icon: '👆',
    color: '#22d3ee',
    keys: ['tap_points_per_tap', 'tap_daily_limit', 'tap_max_batch'],
  },
  {
    label: 'PVP Games',
    icon: '🎲',
    color: '#a78bfa',
    keys: ['pvp_enabled', 'pvp_house_fee_pct', 'pvp_min_bet', 'pvp_max_bet', 'pvp_challenge_timeout_seconds'],
  },
  {
    label: 'Leaderboard',
    icon: '🏆',
...
const SETTING_META: Record<string, {
  ...
  stars_conversion_rate:        { label: 'Stars Rate',              description: 'ADR awarded per 1 Telegram Star',           type: 'number', unit: 'ADR/★'  },
  usdt_conversion_rate:         { label: 'USDT Rate',               description: 'ADR required per 1 USDT withdrawal',        type: 'number', unit: 'ADR/$'  },
  ton_conversion_rate:          { label: 'TON Rate',                description: 'ADR required per 1 TON withdrawal',         type: 'number', unit: 'ADR/◎'  },
  ad_reward_points:             { label: 'Ad Reward',               description: 'ADR given per ad watch',                    type: 'number', unit: 'ADR'    },
  daily_bonus_base:             { label: 'Daily Base Reward',       description: 'Base ADR for daily claim',                  type: 'number', unit: 'ADR'    },
  ...
  points_per_referral:          { label: 'Referrer Reward',         description: 'ADR given to the person who referred',      type: 'number', unit: 'ADR'    },
  referral_bonus_referred:      { label: 'Referred Reward',         description: 'ADR given to the new user joining',         type: 'number', unit: 'ADR'    },
  max_referral_bonus:           { label: 'Max Referral Bonus',      description: 'Maximum total referral ADR per user',       type: 'number', unit: 'ADR'    },
  ...
  spin_reward_min:              { label: 'Min Spin Reward',         description: 'Minimum ADR from a spin',                   type: 'number', unit: 'ADR'    },
  spin_reward_max:              { label: 'Max Spin Reward',         description: 'Maximum ADR from a spin',                   type: 'number', unit: 'ADR'    },
  spin_jackpot:                 { label: 'Jackpot Reward',          description: 'ADR awarded on jackpot',                    type: 'number', unit: 'ADR'    },
  spin_jackpot_chance:          { label: 'Jackpot Chance',          description: 'Probability of jackpot hit',                type: 'number', unit: '%'      },
  tower_reward_multiplier:      { label: 'Tower Multiplier',        description: 'ADR multiplier for Tower Climb',            type: 'number', unit: 'x'      },
  ...
  min_withdrawal_points:        { label: 'Min Withdrawal',          description: 'Minimum ADR needed to withdraw',             type: 'number', unit: 'ADR'    },
  ...
  tap_points_per_tap:           { label: 'ADR per Tap',             description: 'ADR awarded for each tap',                  type: 'number', unit: 'ADR'    },
  tap_daily_limit:              { label: 'Daily Tap Limit',         description: 'Max ADR earnable via tapping per day',      type: 'number', unit: 'ADR'    },
  tap_max_batch:                { label: 'Max Tap Batch',           description: 'Max taps sent per batch request',           type: 'number', unit: 'taps'   },
  pvp_enabled:                  { label: 'PVP Enabled',             description: 'Master switch for PVP game challenges',     type: 'toggle' },
  pvp_house_fee_pct:            { label: 'House Fee %',             description: 'Percentage of pot taken as house fee',      type: 'number', unit: '%'      },
  pvp_min_bet:                  { label: 'Min Bet',                 description: 'Minimum ADR allowed for a PVP bet',         type: 'number', unit: 'ADR'    },
  pvp_max_bet:                  { label: 'Max Bet',                 description: 'Maximum ADR allowed for a PVP bet',         type: 'number', unit: 'ADR'    },
  pvp_challenge_timeout_seconds:{ label: 'Challenge Timeout',       description: 'Seconds before an unaccepted challenge expires', type: 'number', unit: 's' },
