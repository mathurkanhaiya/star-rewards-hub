...
const SETTING_META: Record<string, {
  ...
  tap_points_per_tap:           { label: 'Points per Tap',          description: 'Points awarded for each tap',               type: 'number', unit: 'pts'    },
  tap_daily_limit:              { label: 'Daily Tap Limit',         description: 'Max points earnable via tapping per day',   type: 'number', unit: 'pts'    },
  ...
  pvp_min_bet:                  { label: 'Min Bet',                 description: 'Minimum points allowed for a PVP bet',      type: 'number', unit: 'pts'    },
  pvp_max_bet:                  { label: 'Max Bet',                 description: 'Maximum points allowed for a PVP bet',      type: 'number', unit: 'pts'    },
