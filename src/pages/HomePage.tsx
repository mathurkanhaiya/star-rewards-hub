...
import{BadgeDollarSign,Clock3,Gift,Info,Leaf,LockKeyhole,PlayCircle,RefreshCw,ShieldCheck,Sparkles,Ticket,WalletCards}from'lucide-react';
import{useApp}from'@/context/AppContext';
import{usePreferences}from'@/context/PreferencesContext';
import{claimDailyDrop,claimFarm,claimPromoCode,getAdProviderState,getHomeRewardState,getTransactions,logAdWatch,startFarm,type AdProviderId,type AdProviderState,type HomeRewardState}from'@/lib/api';
...
[data-theme='light'] .hv-hero,[data-theme='light'] .hv-card,[data-theme='light'] .hv-provider,[data-theme='light'] .hv-tx,[data-theme='light'] .hv-promo{background:linear-gradient(145deg,rgba(255,255,255,.96),rgba(245,248,255,.8));border-color:rgba(15,23,42,.09);box-shadow:0 12px 32px rgba(45,58,85,.08);color:#0f172a}[data-theme='light'] .hv-icon,[data-theme='light'] .hv-provider-icon,[data-theme='light'] .hv-btn.secondary,[data-theme='light'] .hv-day{background:rgba(15,23,42,.035);border-color:rgba(15,23,42,.08);color:#0f172a}[data-theme='light'] .hv-bar,[data-theme='light'] .hv-provider-progress{background:rgba(15,23,42,.07)}[data-theme='light'] .hv-balance{color:#9a6300}[data-theme='light'] .hv-info{color:#334155}[data-theme='light'] .hv-promo-input{background:rgba(15,23,42,.035);border-color:rgba(15,23,42,.1);color:#0f172a}
