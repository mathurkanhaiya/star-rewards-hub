...
export default function HomePage() {
  ...
  /* ── Count from transactions (only ad_watch — this is the count used by leaderboard & withdraw) ── */
  ...
  async function handleClaimDrop() {
    ...
    try {
      ...
      if (claimError) { setDropClaimedToday(true); return; }
  ...
  /* ══ MAIN AD (this is the count used by leaderboard & withdraw) ── */
  const onAdReward = useCallback(async () => {
    ...
    setAdsToday(p => p + 1);           // ← this updates the daily count instantly
  ...
  return (
    <>
      ...
      <div className="hp-root">
        ...
        {/* WATCH ADS — Main Ad (this count is used by leaderboard & withdraw) */}
        <div className="hp-ad-card gold">
          ...
          >
            ...
            ) : adsToday >= AD_MAX_PER_DAY ? '✅ COME BACK TOMORROW'
            : adCooldown > 0 ? (
